...
import { 
  ...
  Search, Tag, Layers, Home, Settings, Users, ListChecks, Box, Menu, ChevronDown, LogOut
} from "lucide-react";
...
export default function ItemsGet() {
  ...
  const navItems = [
    ...
    { name: 'Items', icon: <Box size={20} />, path: '/items', active: true },
    { name: 'Checklists', icon: <ListChecks size={20} />, path: '/checklist' },
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              <div className="ml-3 relative">
                <div>
                  ...
                  >
                    ...
                    <ChevronDown className="ml-1 text-gray-400" size={16} />
                  </button>
                </div>
              </div>
              ...
              <button
                ...
                className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 flex items-center"
              >
